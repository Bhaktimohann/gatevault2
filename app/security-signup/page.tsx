        ...
        <div className="auth-content">
          ...
          <div className="glass-card auth-card">
            ...
            <div className="mt-3">
              ...
              <input name="name" value={form.name} onChange={handleChange} type="text" placeholder="Security name" autoComplete="name" className="mt-1 w-full rounded-xl bg-gray-100 p-3 text-gray-800 outline-none focus:ring-2 focus:ring-blue-400" />
            </div>

            <div className="mt-3">
              <p className="text-xs text-gray-400">EMAIL</p>
              <input name="email" value={form.email} onChange={handleChange} type="email" placeholder="security@gmail.com" autoComplete="email" className="mt-1 w-full rounded-xl bg-gray-100 p-3 text-gray-800 outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
